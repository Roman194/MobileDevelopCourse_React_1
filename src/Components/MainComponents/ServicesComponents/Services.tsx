  ...
  return (
    <div className={appearance.main}>
      <div className={titlesCenter}>
        ...
        <Divider />
        <div className={appearance.description}>We provide to you the best choiches for you. Adjust it to your health needs and make sure your undergo treatment with our highly qualified doctors you can consult with us which type of service is suitable for your health</div>
      </div>
